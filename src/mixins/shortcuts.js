    ...
    annotator() {
      return [
        ...
        },
        {
          ...
          function: () => {
            if (this.currentAnnotation) {
              const currentKeypoint = this.currentAnnotation.currentKeypoint
              if (currentKeypoint) {
                this.currentAnnotation.keypoints.deleteKeypoint(currentKeypoint)
...

        {
          ...
          function: () => {
            if (!this.$refs.magicwand.isDisabled) this.activeTool = 'Magic Wand'
          }
        },
        {
          default: ['k'],
