...
export default {
  ...
  methods: {
    ...
    tagFromInput() {
      ...
      const hasSpace = this.input.trim() !== this.input
      ...
      if (this.typeahead === true) {
        if (
          ...
          if (
            ...
            for (const slug in this.existingTags) {
              const text = this.existingTags[slug].toLowerCase()
